          ...
          <div className="flex gap-2 overflow-x-auto md:flex-wrap scrollbar-hide pb-2 md:pb-0 -mx-1 px-1">
            ...
            {categories.map((cat) => {
              const icons: Record<string, React.JSX.Element> = {
                ...
                thali: <GiMeal />, 
                biryani: <GiMeal />,
                "fast-food": <GiFrenchFries />, 
                "street-food": <GiTacos />, 
                pizza: <GiPizzaSlice />,
                burgers: <GiHamburger />,
                burger: <GiHamburger />,
                sandwiches: <GiSandwich />,
                sandwich: <GiSandwich />,
                "rolls-wraps": <GiTacos />,
                "noodles-pasta": <GiNoodles />,
                parathas: <GiBread />,
                paratha: <GiBread />,
                snack: <GiFrenchFries />, 
                snacks: <GiFrenchFries />,
                "chinese-food": <GiNoodles />, 
                chinese: <GiNoodles />, 
                "south-indian": <GiBread />,
                "south-indians": <GiBread />,
                "healthy-food": <Salad />, 
                "tea-coffee": <GiCoffeeCup />,
                "fresh-juices": <GiWaterBottle />,
                "ice-cream": <GiIceCreamCone />,
                beverages: <GiWaterBottle />, 
                beverage: <GiWaterBottle />,
                smoothie: <GiWaterBottle />,
                dessert: <GiCupcake />,
                desserts: <GiCupcake />,
                chips: <GiFrenchFries />,
                default: <Utensils />
